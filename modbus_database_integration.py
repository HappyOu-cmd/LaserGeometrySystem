...
class ModbusDatabaseIntegration:
    ...
    def __init__(self, modbus_server, db_path: str = "modbus_registers.db"):
        ...
        self.holding_doubleword_pairs = [
            ...
            (40523, "Коэффициент смещения диаметра корпуса 2"),
            (40530, "Pmin высота"),
            (40532, "Pmax высота"),
            (40534, "Pmin толщина верхней стенки"),
            (40536, "Pmax толщина верхней стенки"),
            (40538, "Pmin толщина нижней стенки"),
            (40540, "Pmax толщина нижней стенки"),
            (40542, "Pmin толщина дна"),
            (40544, "Pmax толщина дна"),
            (40546, "Pmin диаметр корпуса"),
            (40548, "Pmax диаметр корпуса"),
            (40550, "Pmin диаметр фланца"),
            (40552, "Pmax диаметр фланца"),
            (40554, "Pmin диаметр корпуса 2"),
            (40556, "Pmax диаметр корпуса 2"),
            (40558, "Окно сглаживания измерений"),
            (40560, "Смещение минимума толщины верхней стенки"),
            (40562, "Смещение максимума толщины верхней стенки"),
            (40564, "Смещение минимума толщины нижней стенки"),
            (40566, "Смещение максимума толщины нижней стенки"),
            (40568, "Смещение минимума диаметра корпуса"),
            (40570, "Смещение максимума диаметра корпуса"),
            (40572, "Смещение минимума диаметра фланца"),
            (40574, "Смещение максимума диаметра фланца"),
            (40576, "Смещение минимума толщины дна"),
            (40578, "Смещение максимума толщины дна"),
            (40580, "Смещение минимума диаметра корпуса 2"),
            (40582, "Смещение максимума диаметра корпуса 2"),
        ...
        self.extrapolation_registers = {
            40511, 40512, 40513, 40514, 40515, 40516, 40517, 40518, 40519, 40520, 40521, 40523
        }
