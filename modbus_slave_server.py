...
class ModbusSlaveServer:
    ...
    def init_registers(self):
        ...
        self.holding_registers = {
            ...
            # 40522, 40523: Коэффициент смещения диаметра корпуса 2 (DoubleWord float)
        ...
        self.input_registers = {
            ...
            # 30059, 30060: Средний диаметр корпуса (DoubleWord float)
            58: 0.0,  # Максимальный диаметр корпуса - младшее слово
            59: 0.0,  # Максимальный диаметр корпуса - старшее слово
            
            # 30061, 30062: Максиманльый диаметр корпуса (DoubleWord float)
    ...
    def create_modbus_context(self):
        ...
        # Holding Registers (функции 3, 6, 16) - 40001-40520 (расширенный диапазон)
